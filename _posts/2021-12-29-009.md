...
![Método cíclico de producción de libros, concebido desde la invención de los tipos móviles.]({{site.baseurl}}/assets/img/ciclos.png)

Pero es entendible que esto haya pasado, si observamos como era el modelo de producción editorial antes de la era digital.

![No es casualidad la coincidencia lógica entre esta figura y la anterior]({{site.baseurl}}/assets/img/gutenberg.png)
...
![]({{site.baseurl}}/assets/img/completo.png)
